      ...
      <div style={{
        ...
        <div style={{ padding: "1.25rem 1.5rem", borderBottom: `1px solid ${tk.surfaceBorder}`, display: "flex", alignItems: "center", gap: "0.75rem" }}>
          ...
          <div style={{ flex: 1 }}>
            ...
            <div style={{ fontFamily: "'Roboto Serif', Georgia, serif", fontSize: "0.75rem", color: tk.textMuted, fontStyle: "italic" }}>Quick legal awareness guide</div>
          </div>
        ...
        <div style={{ padding: "0.75rem 1rem 0", borderBottom: `1px solid ${tk.surfaceBorder}`, display: "flex", gap: "0.35rem", overflowX: "auto", flexShrink: 0 }}>
          {TOPICS.map(t => (
            <button key={t.id} onClick={() => setActiveId(t.id)}
              style={{
                padding: "0.5rem 0.85rem", borderRadius: "10px 10px 0 0",
                border: "none",
        ...
        <div style={{ flex: 1, overflowY: "auto", padding: "1.5rem" }}>
            ...
            <div style={{
              ...
              <div style={{ display: "flex", alignItems: "center", gap: "0.5rem", marginBottom: "0.6rem", flexWrap: "wrap" }}>
                ...
                {analysis.riskScore !== undefined && riskColor && (
                  <span style={{ marginLeft: "auto", fontSize: "0.7rem", fontWeight: 700, color: riskColor, background: `${riskColor}22`, padding: "2px 9px", borderRadius: "6px", letterSpacing: "0.05em" }}>
              ...
              <p style={{ fontFamily: "'Roboto Serif', Georgia, serif", fontSize: "0.825rem", color: tk.textSecondary, lineHeight: 1.6, margin: "0 0 0.5rem" }}>
                Based on your document type, we've opened the most relevant section below — <strong style={{ color: tk.gold }}>{topic.title}</strong>.
              </p>
              {(analysis.criticalThreats?.length > 0 || analysis.moderateThreats?.length > 0) && (
                <div style={{ fontFamily: "'Roboto Serif', Georgia, serif", fontSize: "0.78rem", color: tk.textMuted, fontStyle: "italic" }}>
                  ⚡ Found {analysis.criticalThreats?.length || 0} critical + {analysis.moderateThreats?.length || 0} moderate risks. Use these rights below to push back.
                </div>
              )}
            </div>
          )}
          ...
          <p style={{ fontFamily: "'Roboto Serif', Georgia, serif", fontSize: "0.72rem", color: tk.textMuted, fontStyle: "italic", textAlign: "center", marginTop: "1.5rem", padding: "0 1rem", lineHeight: 1.6 }}>
            ⚠️ This is general informational content, not legal advice. Consult a qualified lawyer for specific situations.
          </p>
        </div>
      </div>
    </div>
